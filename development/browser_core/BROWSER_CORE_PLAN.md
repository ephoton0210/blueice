...
|---|---|---|
| [Phase 0](phase-0-license-legal-foundation/PLAN.md) | License/legal foundation (`LICENSE` file, `NOTICE`/`THIRD_PARTY_LICENSES` file, derived-file provenance tracking conventions) | In progress |
