...
| [Phase 15](phase-15-chromium-differential-testing/PLAN.md) | Chromium differential testing: BlueIce's rendering checked against a real Chromium via Puppeteer | In progress (BlueIce-side capabilities — `get_dom`/`screenshot` MCP tools — built and verified; the Puppeteer harness itself not written yet) |
