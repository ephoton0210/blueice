...
| [Phase 15](phase-15-chromium-differential-testing/PLAN.md) | Chromium differential testing: BlueIce's rendering checked against a real Chromium via Puppeteer | In progress (stage 1 done: the Node.js harness drives BlueIce via MCP and captures DOM+screenshot for all 28 fixtures; stage 2, adding Puppeteer/Chromium and the actual diff, not started) |
