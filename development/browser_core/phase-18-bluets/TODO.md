...
**Current leaf: C3.1.3.2.3.3.** Prove the installed root-slot join remains
generation-bound across classic, module, and linked direct programs and
refuses stale or cross-program reuse.
