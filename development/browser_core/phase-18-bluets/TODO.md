...
**Current leaf: C3.1.3.4.4.** Add distinct bounded same-stream ordinary/linked
static scope receipts tied to the core pause incarnation; keep linked
receipts unusable by `Value` and default-deny relation reads.
