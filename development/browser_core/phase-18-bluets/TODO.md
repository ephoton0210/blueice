...
**Current leaf: C3.1.3.5.** Prove static type display and independently
authorized runtime preview remain distinct for the same paused slot on real
Launcher sockets, including step/reload/cutover expiry.
