...
**Current leaf: C1.2.1.4.** Prove a nested pause and same-frame instruction
successor on a real BlueTS page through the public debugger socket; retain
unsupported call-shape denial.
