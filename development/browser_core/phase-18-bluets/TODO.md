...
**Current leaf: C3.1.3.4.7.5.4.2.4.** Split the remaining host
snapshot/admission, module execution, stepping, and lifecycle tests, then
verify the complete test family is below 1,300 lines per file.
