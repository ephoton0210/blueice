...
## Later BlueJS per-file coverage (2026-09-24)

This is a separate, later coverage measurement at commit `06724eed` on macOS 27.0 (`arm64`), Rust 1.95.0 and `cargo-llvm-cov` 0.9.1. It does **not** describe the 2026-09-21 Test262 run or the same-revision verification table above. `cargo llvm-cov -p blueice-bluejs --summary-only --quiet` completed successfully, and `cargo llvm-cov report -p blueice-bluejs --json --summary-only` supplied the per-file counts below. The default BlueJS suite was run without source-file exclusions; the opt-in Node oracle and external full Test262 runner were not included. Workspace coverage was not remeasured at this commit.

Each measured cell shows covered / instrumented followed by the coverage rate. All 171 Rust files under `backend/bluejs/src/` are listed: 158 have counters in the LLVM export, while 13 have no per-file counters and are shown as `—`. A missing counter is not a measured 0% result. The total aggregates the 158 instrumented files. Region coverage measures LLVM source regions and is separate from branch coverage.

| Source file (relative to `backend/bluejs/src/`) | Lines | Functions | Regions |
| --- | ---: | ---: | ---: |
| [`ast.rs`](../../../backend/bluejs/src/ast.rs) | 892 / 894 (99.78%) | 89 / 89 (100.00%) | 1,163 / 1,167 (99.66%) |
...
| [`bytecode.rs`](../../../backend/bluejs/src/bytecode.rs) | 85 / 85 (100.00%) | 11 / 11 (100.00%) | 83 / 87 (95.40%) |
| [`compiler.rs`](../../../backend/bluejs/src/compiler.rs) | 1,399 / 1,445 (96.82%) | 134 / 140 (95.71%) | 1,960 / 2,076 (94.41%) |
| [`compiler/expressions.rs`](../../../backend/bluejs/src/compiler/expressions.rs) | 1,352 / 1,487 (90.92%) | 36 / 36 (100.00%) | 2,869 / 3,506 (81.83%) |
| [`compiler/functions.rs`](../../../backend/bluejs/src/compiler/functions.rs) | 964 / 982 (98.17%) | 52 / 52 (100.00%) | 1,658 / 1,819 (91.15%) |
...
| [`compiler/statements.rs`](../../../backend/bluejs/src/compiler/statements.rs) | 1,293 / 1,351 (95.71%) | 68 / 70 (97.14%) | 2,350 / 2,666 (88.15%) |
...
| [`heap/tests.rs`](../../../backend/bluejs/src/heap/tests.rs) | — | — | — |
| [`intl.rs`](../../../backend/bluejs/src/intl.rs) | 100 / 101 (99.01%) | 17 / 17 (100.00%) | 154 / 159 (96.86%) |
| [`lib.rs`](../../../backend/bluejs/src/lib.rs) | — | — | — |
...
| [`parser/tests.rs`](../../../backend/bluejs/src/parser/tests.rs) | — | — | — |
...
| [`vm/builtins/execution.rs`](../../../backend/bluejs/src/vm/builtins/execution.rs) | — | — | — |
...
| [`vm/builtins/native_dispatch.rs`](../../../backend/bluejs/src/vm/builtins/native_dispatch.rs) | — | — | — |
...
| [`vm/builtins/tests.rs`](../../../backend/bluejs/src/vm/builtins/tests.rs) | — | — | — |
...
| [`vm/execution.rs`](../../../backend/bluejs/src/vm/execution.rs) | 1,369 / 1,514 (90.42%) | 130 / 139 (93.53%) | 2,253 / 2,558 (88.08%) |
...
| [`vm/temporal/conversion.rs`](../../../backend/bluejs/src/vm/temporal/conversion.rs) | — | — | — |
...
| [`vm/temporal/dates.rs`](../../../backend/bluejs/src/vm/temporal/dates.rs) | — | — | — |
...
| [`vm/temporal/iso/tests.rs`](../../../backend/bluejs/src/vm/temporal/iso/tests.rs) | — | — | — |
| [`vm/temporal/plain_date.rs`](../../../backend/bluejs/src/vm/temporal/plain_date.rs) | — | — | — |
...
| [`vm/temporal/plain_date/tests.rs`](../../../backend/bluejs/src/vm/temporal/plain_date/tests.rs) | — | — | — |
...
| [`vm/temporal/zoned.rs`](../../../backend/bluejs/src/vm/temporal/zoned.rs) | — | — | — |
...
| [`vm/tests.rs`](../../../backend/bluejs/src/vm/tests.rs) | — | — | — |
| **Total (158 instrumented files)** | **67,872 / 73,153 (92.78%)** | **4,971 / 5,329 (93.28%)** | **113,547 / 126,212 (89.97%)** |
