...
The Temporal/Test262 figures recorded throughout this long-lived plan are dated per-merge snapshots; this section is authoritative over them. On 2026-09-21 the complete, unfiltered Test262 inventory (53,582 files / 102,926 modes) ran on macOS and Ubuntu (Windows in progress), on commit `eaeb5c1`. The current full-run Temporal result is **13,268 / 13,268 (100.000%)** combined `built-ins/Temporal/` (9,210 / 9,210 (100.000%)) and `intl402/Temporal/` (4,058 / 4,058 (100.000%)) modes, with no Temporal timeouts, on Ubuntu 24.04.4 LTS (native, Intel Core i5-9400T, pinned Rust/Cargo 1.95.0, 6 jobs, 542.255 seconds) and identically on macOS 26.6.2 (Apple M4, Rust/Cargo 1.98.0, 8 jobs, 324.897 seconds). Every mode tagged `features: [Temporal]` (13,432, including files outside the Temporal directories) also passes on both.
