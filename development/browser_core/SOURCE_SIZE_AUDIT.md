...
It excludes `target/`, vendored dependencies, generated output, and non-Rust assets. On this review there are **46 files at or above 1,200 lines** and **zero above 2,200 lines**. The earlier audit's large monolith paths and counts are historical: the extractions now present in the source tree are reflected below.
