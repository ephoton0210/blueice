...
use blueice_bluets_bluejs::page_host_typings::{
    page_host_document_context_bindings_v1, page_host_dom_event_bindings_v1,
    page_host_dom_mutation_bindings_v1, page_host_dom_text_bindings_v1, PageHostBindingRoleV1,
};
...
pub use blueice_bluets_bluejs::page_host_typings::PAGE_HOST_DOM_EVENT_PROFILE_V1 as CORE_SCRIPT_DOM_EVENT_PROFILE_V1;
...
pub fn core_script_host_type_catalog() -> HostTypeSurfaceCatalogV1 {
    HostTypeSurfaceCatalogV1::new([
        ...
        HostTypeSurfaceV1::new(
            BLUEICE_HOST_TYPINGS_LANGUAGE_VERSION_V1,
            blueice_bluets_bluejs::page_host_typings::PAGE_HOST_DOM_EVENT_HOST_API_VERSION_V1,
            CORE_SCRIPT_DOM_EVENT_PROFILE_V1,
...
mod tests {
    ...
    #[test]
    fn live_dom_event_manifest_matches_the_child_selected_artifact() {
        let artifact = core_script_host_type_catalog()
            .generate(CORE_SCRIPT_DOM_EVENT_PROFILE_V1)
            .unwrap();
        let child =
            blueice_bluets_bluejs::page_host_typings::PageHostDocumentTypingsV1::generate_dom_event(
            );
        assert_eq!(artifact.declaration_source, child.declaration_source);
        assert_eq!(artifact.manifest.binding_ids.len(), 10);
        assert_eq!(
            artifact
                .runtime_bindings
                .iter()
