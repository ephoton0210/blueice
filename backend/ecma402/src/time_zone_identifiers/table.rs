...
//
// tz database release 2026c: 598 names, 152 of them not primary,
// 446 primary identifiers.

pub(super) const TZDATA_VERSION: &str = "2026c";
...
pub(super) static NON_PRIMARY_IDENTIFIERS: [(&str, &str); 152] = [
