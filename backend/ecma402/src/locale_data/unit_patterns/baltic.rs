...
/// records.
pub(crate) fn cldr_lithuanian_per_unit_pattern(
    locale: &str,
...
pub(crate) fn cldr_lithuanian_generic_compound_unit_pattern(
    locale: &str,
    ...
    let numerator_raw = cldr_lithuanian_additional_unit_pattern(locale, numerator, display, plural);
    let denominator_raw = cldr_lithuanian_additional_unit_pattern(
        locale,
        denominator_unit,
        denominator_display,
...
pub(crate) fn cldr_latvian_per_unit_pattern(
    locale: &str,
    denominator: crate::NumberFormatUnit,
    display: crate::NumberUnitDisplay,
) -> Option<&'static str> {
...
pub(crate) fn cldr_latvian_generic_compound_unit_pattern(
    locale: &str,
    numerator: crate::NumberFormatUnit,
    denominator: crate::NumberFormatUnit,
    display: crate::NumberUnitDisplay,
    ...
    let numerator_raw = cldr_latvian_additional_unit_pattern(locale, numerator, display, plural);
    let denominator_raw = cldr_latvian_additional_unit_pattern(
        locale,
        denominator_unit,
        denominator_display,
        crate::PluralCategory::One,
