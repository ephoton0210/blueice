...
pub(crate) enum NativeFunction {
    ...
    TemporalPlainDateToPlainMonthDay,
    TemporalPlainDateTimeToPlainDate,
    ...
    DisplayNamesSupportedLocales,
    DisplayNamesOf,
    DisplayNamesResolvedOptions,
    DurationFormatSupportedLocales,
    ...
    PluralRulesSupportedLocales,
    PluralRulesSelect,
    PluralRulesSelectRange,
    PluralRulesResolvedOptions,
    SegmenterSupportedLocales,
    SegmenterResolvedOptions,
    SegmenterSegment,
    SegmentsContaining,
    SegmentsIterator,
    SegmentIteratorNext,
    RelativeTimeFormatSupportedLocales,
    ...
    /// The abstract `Iterator` constructor. It is exposed as a function but
